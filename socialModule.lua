...
social.sendfbAppCapture(group,imageName,message -- Posts a screen capture of the GROUP you have selected.

example: social.sendfbAppCapture(sceneView,"filename.jpg","Look at my app! LOOK AT IT!")
...
social.sendTweetAppCapture(group,image,tweetMessage) -- Sends a tweet along with a screen capture of the GROUP you have selected.

example: social.sendTweetAppCapture(sceneView,"filename.jpg","This will be tweeted!")
...
social.sendMailAppCapture(group,image,mailTo,mailSubject,mailMessage) -- Sends an email along with a screen capture of the GROUP you have selected.

example: social.sendMailAppCapture(sceneView,"filename.jpg","test@test.com","Check this app out!","So this is my app! // Mike")
...
function social.sendfbAppCapture(imageName,message)
	...
	function social.request()
		...
		local fbTimer1 = timer.performWithDelay(100,function()
			...
			display.save(stage, Image, system.DocumentsDirectory)

			fbTimer1 = nil
			local fbTimer2 = timer.performWithDelay(100,social.request)
...
local newImage = image
	...
	stage = display.getCurrentStage()
	display.save(stage, newImage, system.DocumentsDirectory)
...
function social.sendMailAppCapture(group,image,mailTo,mailSubject,mailMessage)
	...
	display.save(group, image, system.DocumentsDirectory)
